...
AssignStmt
    :
    LVal ASSIGN Exp SEMICOLON { //left value = ... ;
        $$ = new AssignStmt($1, $3);
    }
    ;
BlockStmt  //语句块
    :   LBRACE 
        ...
        {identifiers = new SymbolTable(identifiers);} //作用域
        Stmts RBRACE 
        {
...
IfStmt
    ...
    ;
WhileStmt  //While语句
    : WHILE LPAREN Cond RPAREN Stmt { // while(condition)
        $$ = new WhileStmt($3, $5);
    }
    ;
BreakStmt   //Break语句
